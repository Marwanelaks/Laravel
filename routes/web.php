...
Route::group(['prefix' => '/{type}','middleware' => 'auth'], function () {
    Route::get("/create", [ElevesController::class, "create"]);
    Route::get("/list", [ElevesController::class, "index"]);
    Route::get("{id}/{method}", [ElevesController::class, "show"])->name("show");
    Route::post('/creation', [ElevesController::class, "store"]);
    // Route::get('/modifier/{id}', [ElevesController::class, "edit"]);
    Route::put('{id}', [ElevesController::class, "update"]);
    Route::delete("supprimer/{id}", [ElevesController::class, "destroy"]);
});
